    ...
    try:
        ...
        final_output = {
            ...
            "ai_summary": {
                ...
                "instructions_for_ai": f"SYSTEM INSTRUCTION: DO NOT GUESS ZODIAC SIGNS! Rashi is {moon_sign} and Lagna is {lagna}. Look at dasha_info for timing predictions. 🚨 HYPER-CRITICAL LANGUAGE LOCK: You MUST analyze the EXACT LANGUAGE of the user's last message. If the user spoke ENGLISH (e.g. 'tell me about my career'), YOU MUST ABANDON HINGLISH ENTIRELY AND REPLY 100% IN PURE ENGLISH right now! Do NOT use Hindi words like 'shaadi', 'kaise ho', or 'beta' in English mode! If the user spoke HINGLISH/HINDI, you MUST reply 100% IN HINGLISH. If the user spoke PORTUGUESE or BRAZILIAN PORTUGUESE, reply 100% in Brazilian Portuguese (pt-BR). CRITICAL FOR IMAGE GENERATION: When running draw_kundli_traditional.py, you MUST copy the ENTIRE planet_positions array."
            }
        }
